...
if __name__ == "__main__":
    ...
    result = md.analyser.load_analyser_result(
        "/home/zhenyuwei/simulation_data/22-07-coulombic-blockade/code/aamd/carbon_nanotube/simulation/hydration_layer/out/no-wall-charge-short-time/no-pore-w0-2.000A-ls-25.000A-POT-1.00e-01molPerL/%s-x-0.00A-y-0.00A-z-0.00A/%s-rdf-x-0.000A-y-0.000A-z-0.000A.npz"
