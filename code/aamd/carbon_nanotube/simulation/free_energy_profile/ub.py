...
def generate_simulation_recipe(center_ion_type, z_range):
    simulation_recipe = [
        ...
        },
        {
            ...
            "temperature": Quantity(300, kelvin),
            "center_coordinate": [0, 0, z_range[0]],
    ...
    for z0 in z_range:
        ...
        simulation_recipe.extend(
            [
                {
                    "name": "equilibrate_nvt_with_bias_potential",
                    "num_steps": 100000,
                    "step_size": Quantity(0.5, femtosecond),
                    "temperature": Quantity(300, kelvin),
                    "center_ion_type": center_ion_type,
                    "z0": z0,
                    "out_prefix": z0_name + "-eq",
                    "out_freq": 10000,
                },
                {
                    "name": "sample_nvt_with_bias_potential",
                    "num_steps": 500000,
                    "step_size": Quantity(1, femtosecond),
                    "temperature": Quantity(300, kelvin),
                    "center_ion_type": center_ion_type,
                    "z0": z0,
                    "out_prefix": z0_name + "-sample",
                    "out_freq": 1000,
                },
            ]
        )
...
if __name__ == "__main__":
    out_dir = os.path.join(CUR_DIR, "out/ub")
    job_args = []
    r0_list = [
    ...
    z_padding = 5
    z_range = [-25, 0]
    z_range = np.arange(z_range[0] - z_padding, z_range[1] + z_padding, 1.0)[::-1]
    print(z_range)
    json_file_path_list = []
